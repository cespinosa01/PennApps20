...
def find_tomato(image):
    ...
    # Clean up
    #we want to circle our tomato so we'll circle it with an ellipse
    ...
    big_tomato_contour, mask_strawberries = find_biggest_contour(mask_clean)

    # Overlay cleaned mask on image
    # overlay mask on image, tomato now segmented
    overlay = overlay_mask(mask_clean, image)

    # Circle biggest tomato
...
#write the new image
cv2.imwrite('tomato_new.png', result)
#print("tomato") find a way to print it onto the thing
