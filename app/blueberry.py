...
def find_blueberry(image):
    ...
    big_blueberry_contour, mask_strawberries = find_biggest_contour(mask_clean)
    ...
    circled = circle_contour(overlay, big_blueberry_contour)
    show(circled)
...
#read the image
image = cv2.imread('blueberry_1.png')
#detect it
result = find_blueberry(image)
#write the new image
cv2.imwrite('blueberry_6.jpg', result)
